export const CONTENT = {
  ...
  team: {
    heading: 'Tim Kami',
    subheading: 'Profesional yang Memahami Teknologi dan Bisnis',
    members: [
      {
        name: 'Leynardo Yosef',
        role: 'Lead Developer & IT Consultant',
        image: '/images/ley-jacket.webp',
        description:
          'Berpengalaman membantu berbagai bisnis dalam transformasi digital. Ahli dalam merancang solusi yang scalable dan sesuai kebutuhan bisnis.',
      },
      {
        name: 'Dicky Trifadillah',
        role: 'Senior Developer',
        image: '/images/dicky.webp',
        description:
          'Spesialis dalam pengembangan aplikasi web dan mobile yang user-friendly dan performa tinggi untuk berbagai industri.',
      },
      {
        name: 'Kenang Andriansyah',
        role: 'UI/UX Designer',
        image: '/images/kenang.webp',
        description:
          'Merancang interface yang tidak hanya cantik, tapi juga intuitif dan meningkatkan conversion untuk bisnis Anda.',
      },
    ],
  },
